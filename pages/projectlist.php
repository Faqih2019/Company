...
href="index.php?p=project&pnumber=' . $dataProject->pnumber . '"> Edit </a> |
<a class="btn btn-danger"
href="index.php?p=deleteproject&pnumber=' . $dataProject->pnumber . '" onclick="return confirm(\'Apakah anda yakin ingin menghapus?\')"> Delete </a></td>';
echo '</tr>';
$no++;
}
}
