...
<form action="" method="post"> 
    <table class="table" border="0"> 
        ...
        <input type="password" name="password" id="password" class="form-control" maxlength="30" required> </tr> 
        <tr> 
        <td>Nama</td> 
        <td>:</td> 

        <td><input type="text" class="form-control" id="name" name="name" maxlength="30" required></td> </tr> 
        <tr> 
        <td></td> 
        <td></td> 
